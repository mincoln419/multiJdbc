...
@MapperScan(value="com.ideatec.datamigration.obedm.dao", sqlSessionFactoryRef = "db1SqlSessionFactory")
public class EdmDatasourceConfiguration {
	...
	@Primary
	public SqlSessionTemplate db1SqlSessionTemplate(SqlSessionFactory sessionFactory) throws Exception {
